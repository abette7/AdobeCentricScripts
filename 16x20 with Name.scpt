--script expects a PDF export preset in InDesign named "Press with Marks" with crop marks and slug enabled.
--May require read/write permissions enabled on InDesign application folder and enclosed items
--when launched from script editor or as an exported app, starts with 'on run'
on run
...
--when files are dropped on the icon of the exported app, starts with 'on open'
on open theItems
	repeat with i from 1 to number of items in theItems
		...
		tell application id "com.adobe.indesign"
			...
			tell page 1 of document 1
				...
				set rect2 to make new text frame with properties {stroke weight:"0", stroke color:"None", geometric bounds:{"20in", "0in", "20.25in", "15.75in"}}
