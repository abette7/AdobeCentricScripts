...
on open theItems
	repeat with i from 1 to number of items in theItems
		tell application id "com.adobe.indesign"
			make new document with properties {document preferences:{page width:"12in", page height:"18in", facing pages:false}}
			...
			tell page 1 of document 1
				set rect1 to make new rectangle with properties {stroke weight:"0", stroke color:"None", geometric bounds:{"0in", "0in", "18in", "12in"}}
				...
				if ImageWidth is greater than ImageHeight then
					...
					tell application id "com.adobe.indesign"
						set page width of document preferences of active document to "18in"
						set page height of document preferences of active document to "12in"
						tell page 1 of document 1
							set geometric bounds of rect1 to {0, 0, 12, 18}
