...
on open theItems
	...
	tell application id "com.adobe.indesign"
		make new document with properties {document preferences:{page width:"43in", page height:"20in"}}
		...
		tell page 1 of document 1
			...
			set rect1 to make new rectangle with properties {stroke weight:"0", stroke color:"None", geometric bounds:{"0.5in", "0.5in", "19.2847in", "13.2847in"}}
