	...
	repeat with i from 1 to number of items in theItems
		...
		tell application id "com.adobe.indesign"
			...
			tell page 1 of document 1
				set rect1 to make new rectangle with properties {stroke weight:"0", stroke color:"None", geometric bounds:{"1.3136 in", "0.5in", "5.5461in", "10.0445in"}}
				...
				set rect3 to make new rectangle with properties {stroke weight:"0", stroke color:"None", geometric bounds:{"7.3057in", "2.2313 in", "11.5382 in", "7.7638in"}}
