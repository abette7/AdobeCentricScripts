...
on open theItems
	...
	tell application id "com.adobe.indesign"
		make new document with properties {document preferences:{page width:"42in", page height:"20in"}}
		...
		tell page 1 of document 1
			...
			set rect1 to make new rectangle with properties {stroke weight:"0", stroke color:"None", geometric bounds:{"0.3514in", "0.1486in", "13.9347in", "19.732in"}}
		...
		tell document 1
			...
			tell data merge preferences of myDataMerge
				...
				set column spacing to "0.125in"
				set row spacing to ".125in"
				set left margin to ".125in"
				set top margin to ".125in"
			end tell
			merge records myDataMerge
		end tell
		--export pdf and save indd		
		set pdfname to the POSIX path of (myCSVpath & "list.pdf")
		set inddName to the POSIX path of (myCSVpath & "list.indd")
